...
namespace audio_mix {
// Clinically-safe clip volume range; everything below the floor is silenced by
// db_to_gain, while the slider stays linear in dB so users can reach exact
// silence by dragging to the floor.

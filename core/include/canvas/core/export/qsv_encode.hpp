...
// VAAPI encoder rate-control mapping (docs/qsv.md 7.D5 / 8.1).
//
...
//   rc_mode           "ICQ" (constant quality, closest analog to CRF),
//                     "QVBR" (quality-targeted VBR), "CQP", "VBR", "CBR"
...
// without linking libavcodec; the apply() half is a thin av_opt_set wrapper.

#include <cstdint>
#include <string>

// Forward-declared only  this header does not pull in libavcodec. Users that
// actually call apply_qsv_rate_control() must include <libavcodec/avcodec.h>
// (attributes a full type) like the exporter does.
struct AVCodecContext;

namespace canvas::core {

// True when the FFmpeg encoder name is a VAAPI encoder ("h264_qsv",
// "hevc_qsv", "av1_qsv", ...).
...
//
//   codec_name           FFmpeg encoder name (e.g. "h264_qsv")

...
- **Test:** `ctest --test-dir build`. **25 tests** (verified passing on this machine):
  ...
  - If you quote a test count elsewhere, assume these 25 and re-verify with `ctest --test-dir build` before quoting.
